...
//listar por id
    ...
    public CuentaDTO depositarDinero(Long idCuenta, double monto) {
        ...
        transaccion.setTipoTransaccion(TipoTransaccion.valueOf(String.valueOf(TipoTransaccion.DEPOSITO)));
    ...
    public CuentaDTO retirarDinero(Long idCuenta, double monto) {
        ...
        Transaccion transaccion = new Transaccion();
        transaccion.setTipoTransaccion(TipoTransaccion.valueOf(String.valueOf(TipoTransaccion.EXTRACCION)));
        transaccion.setIdCuentaDestino(cuenta.getId());
        transaccion.setMonto(-monto);
        transaccionRepository.save(transaccion);
